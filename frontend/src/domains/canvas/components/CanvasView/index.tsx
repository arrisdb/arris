...
/// (text/query/chart/shape) plus a floating add-toolbar. The agent chat and the
/// object properties pane live in the app shell's left and right sidebars (see
/// `registerCanvasPanes`), so the board fills the whole center tab here.
