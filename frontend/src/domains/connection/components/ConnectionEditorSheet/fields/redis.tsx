...
export function RedisFields({ config, patch, showSsh, setShowSsh, uri, onUriChange }: FieldsProps) {
  return (
    <>
      <FormRow label="Host">
      ...
      <FormRow label="Database">
        <Field value={config.database} onChange={(v) => patch("database", v)} monospace placeholder="0" />
      </FormRow>
      <FormRow label="User">
